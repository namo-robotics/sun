 ...
 * Generic intrinsics take a type argument: _sizeof&lt;T&gt;(),
 * _load&lt;T&gt;(ptr, idx) Non-generic intrinsics are called like regular
 * functions: _malloc(size)
 */
enum class Intrinsic {
  ...
  PrintU64,      // _print_u64(value) -> void
...
inline Intrinsic getIntrinsic(const std::string& name) {
  ...
  if (name == "_print_u64") return Intrinsic::PrintU64;
