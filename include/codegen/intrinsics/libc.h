...
/** Finds or declares a C runtime function with the requested LLVM signature. */
...
/** Returns the LLVM integer type used for C integer arguments. */
inline llvm::Type* i32(llvm::Module* m) {
  return llvm::Type::getInt32Ty(m->getContext());
}
/** Returns the LLVM integer type used for wide runtime values. */
inline llvm::Type* i64(llvm::Module* m) {
  return llvm::Type::getInt64Ty(m->getContext());
}
/** Returns the LLVM pointer type used by runtime calls. */
