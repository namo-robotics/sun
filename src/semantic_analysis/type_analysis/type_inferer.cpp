/**
 * Computes types from explicitly supplied facts.
 *
 * Convention: type_inferer, generic_type_arguments, type_checking, and
 * type_traits are the pure part of type analysis. They must not use semantic
 * sessions, expression ASTs, diagnostics, or specialization services. Treat
 * supplied types as read-only; return results or failures to the caller.
 * Contextual work belongs in type_resolver, type_rules, or semantic handlers.
 */
