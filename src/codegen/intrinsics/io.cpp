...
static Function* getOrCreateFileOpenHelper(llvm::Module* module,
  ...
  Value* fd = builder.CreateCall(sun::codegen::intrinsics::open(module),
                                 {path, flags, mode}, "fd");
...
static Function* getOrCreateFileCloseHelper(llvm::Module* module,
  ...
  auto* i32Ty = llvm::Type::getInt32Ty(llvmCtx);
  llvm::FunctionType* funcType = llvm::FunctionType::get(i32Ty, {i32Ty}, false);
  func = Function::Create(funcType, Function::InternalLinkage,
  ...
  Value* result = builder.CreateCall(sun::codegen::intrinsics::close(module),
                                     {fd}, "close_result");
...
static Function* getOrCreateFileWriteHelper(llvm::Module* module,
  ...
  Value* result = builder.CreateCall(sun::codegen::intrinsics::write(module),
...
static Function* getOrCreateFileReadHelper(llvm::Module* module,
  ...
  llvm::FunctionType* funcType =
      llvm::FunctionType::get(ptrTy, {i32Ty, i32Ty}, false);
  func = Function::Create(funcType, Function::InternalLinkage,
  ...
  Value* bufPtr = builder.CreateCall(sun::codegen::intrinsics::malloc(module),
                                     {bufSize}, "buf");

  Value* readResult = builder.CreateCall(sun::codegen::intrinsics::read(module),
...
Value* IntrinsicsGenerator::codegenFileRead(const CallExprAST& expr) {
  ...
  if (!count->getType()->isIntegerTy(32)) {
    count =
        ctx.builder->CreateSExtOrTrunc(count, llvm::Type::getInt32Ty(llvmCtx));
  }
...
static Function* getOrCreateLseekHelper(llvm::Module* module,
  ...
  return sun::codegen::intrinsics::forwarder(
      module, "__sun_lseek", sun::codegen::intrinsics::lseek(module),
...
static Function* getOrCreateFstatHelper(llvm::Module* module,
  ...
  auto* ptrTy = PointerType::getUnqual(llvmCtx);
  return sun::codegen::intrinsics::forwarder(
      module, "__sun_fstat", sun::codegen::intrinsics::fstat(module),
      {i32Ty, ptrTy}, i32Ty);
}
...
static Function* getOrCreateFsyncHelper(llvm::Module* module,
  ...
  auto* i32Ty = llvm::Type::getInt32Ty(llvmCtx);
  return sun::codegen::intrinsics::forwarder(
      module, "__sun_fsync", sun::codegen::intrinsics::fsync(module), {i32Ty},
      i32Ty);
}
...
static Function* getOrCreateFtruncateHelper(llvm::Module* module,
  ...
  auto* i64Ty = llvm::Type::getInt64Ty(llvmCtx);
  return sun::codegen::intrinsics::forwarder(
      module, "__sun_ftruncate", sun::codegen::intrinsics::ftruncate(module),
      {i32Ty, i64Ty}, i32Ty);
}
...
static Function* getOrCreateUnlinkHelper(llvm::Module* module,
  ...
  auto* ptrTy = PointerType::getUnqual(llvmCtx);
  return sun::codegen::intrinsics::forwarder(
      module, "__sun_unlink", sun::codegen::intrinsics::unlink(module), {ptrTy},
      i32Ty);
}
...
static Function* getOrCreateRenameHelper(llvm::Module* module,
  ...
  auto* ptrTy = PointerType::getUnqual(llvmCtx);
  return sun::codegen::intrinsics::forwarder(
      module, "__sun_rename", sun::codegen::intrinsics::rename(module),
      {ptrTy, ptrTy}, i32Ty);
}
...
static Function* getOrCreateMkdirHelper(llvm::Module* module,
  ...
  auto* ptrTy = PointerType::getUnqual(llvmCtx);
  return sun::codegen::intrinsics::forwarder(
      module, "__sun_mkdir", sun::codegen::intrinsics::mkdir(module),
      {ptrTy, i32Ty}, i32Ty);
}
...
static Function* getOrCreateRmdirHelper(llvm::Module* module,
  ...
  auto* ptrTy = PointerType::getUnqual(llvmCtx);
  return sun::codegen::intrinsics::forwarder(
      module, "__sun_rmdir", sun::codegen::intrinsics::rmdir(module), {ptrTy},
      i32Ty);
}
...
static Function* getOrCreateWriteHelper(llvm::Module* module,
  ...
  auto* ptrTy = PointerType::getUnqual(llvmCtx);
  return sun::codegen::intrinsics::forwarder(
      module, "__sun_write", sun::codegen::intrinsics::write(module),
...
static Function* getOrCreateReadHelper(llvm::Module* module,
  ...
  auto* ptrTy = PointerType::getUnqual(llvmCtx);
  return sun::codegen::intrinsics::forwarder(
      module, "__sun_read", sun::codegen::intrinsics::read(module),
      {i32Ty, ptrTy, i64Ty}, i64Ty);
}
...
Value* IntrinsicsGenerator::codegenLseek(const CallExprAST& expr) {
  ...
  if (!offset->getType()->isIntegerTy(64)) {
    offset =
        ctx.builder->CreateSExtOrTrunc(offset, llvm::Type::getInt64Ty(llvmCtx));
  }
  if (!whence->getType()->isIntegerTy(32)) {
    whence =
        ctx.builder->CreateSExtOrTrunc(whence, llvm::Type::getInt32Ty(llvmCtx));
  }
...
Value* IntrinsicsGenerator::codegenFtruncate(const CallExprAST& expr) {
  ...
  if (!length->getType()->isIntegerTy(64)) {
    length =
        ctx.builder->CreateSExtOrTrunc(length, llvm::Type::getInt64Ty(llvmCtx));
  }
...
Value* IntrinsicsGenerator::codegenMkdir(const CallExprAST& expr) {
  ...
  if (!mode->getType()->isIntegerTy(32)) {
    mode =
        ctx.builder->CreateSExtOrTrunc(mode, llvm::Type::getInt32Ty(llvmCtx));
  }
