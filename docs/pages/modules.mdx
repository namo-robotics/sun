...
manifest {
    suns: [
        "allocator.sun", "unique.sun", "errors.sun", "option.sun",
        "iterator.sun", "slice.sun", "contiguous_buffer.sun", "vec.sun",
        "matrix.sun", "string.sun", "print.sun", "map.sun", "linked_list.sun",
        "mutex.sun", "math.sun", "io.sun", "networking.sun", "http.sun",
        "proto_wire.sun"
    ]
}
```
...
| `print.sun` | Overloaded `print`/`println` functions |
