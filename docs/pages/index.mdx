...
Sun is a general-purpose programming language designed for robotics and AI. 
It provides Rust-style memory safety while retaining a familiar syntax and classic concepts such as classes and interfaces. 
...
- **Designed for Robotics**: Robotics software typically involves dozens to
    ...
    which Sun provides builtin support for. A custom DDS and middleware are on the roadmap.
- **Designed for AI**: NumPy-like N-D matrices and linear algebra provided in the standard library.
  Builtin support for hardware accelerators/GPUs using LLVM Offload is on the roadmap.
