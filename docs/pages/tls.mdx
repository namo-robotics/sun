...
<Callout type="info">
  ...
  along](/c-ffi#carrying-the-c-library-along) for how the archives travel.
</Callout>
...
Debian packages also include AArch64 Linux TLS and standard-library bundles.
...
sharing one build share one copy; see [C FFI](/c-ffi).
