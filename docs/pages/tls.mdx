...
```sun
manifest {
    source_files: ["openssl.sun", "tls_stream.sun", "https_client.sun"]
...
The bundle's own tests are Sun code, `tls/https_client_tests.sun`, listed
under `test_files:` in `tls/tls.sun` (see [Testing](/testing)) and compiled
