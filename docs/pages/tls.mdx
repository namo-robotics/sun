...
```sun
public function get(host: ref String, path: static_ptr<u8>) HttpClientResponse, IError
public function get(host: ref String, port: i32, path: static_ptr<u8>) HttpClientResponse, IError
public function post(host: ref String, path: static_ptr<u8>, content_type: static_ptr<u8>,
                     body: const ref String) HttpClientResponse, IError
```
