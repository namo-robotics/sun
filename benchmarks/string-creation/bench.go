// Measure decimal string creation in an owned ring buffer.
package main
...
// fromInt replaces ring slots with freshly formatted integers.
//go:noinline
func fromInt(n int) {
	for i := 0; i < n; i++ {
...
// main warms up, reports the best elapsed time, and checks retained lengths.
func main() {
	const N = 100_000_000
