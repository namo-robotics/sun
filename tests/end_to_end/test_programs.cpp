// tests/end_to_end/test_programs.cpp
...
TEST(EndToEnd_Programs, mutual_recursion) {
  auto value = executeString(R"(
...
TEST(EndToEnd_Programs, square_func) {
  auto value = executeString(R"(
...
TEST(EndToEnd_Programs, foo_bar) {
  auto value = executeString(R"(
...
TEST(EndToEnd_Programs, closure) {
  auto value = executeString(R"(
    function main() i32 {
        var x: i32 = 1;
        var f = lambda () i32 {
...
TEST(EndToEnd_Programs, function_var) {
...
TEST(EndToEnd_Programs, var_assign) {
  auto value = executeString(R"(
    function main() i32 {
        var x: i32 = 1;
        x = 2;
...
TEST(EndToEnd_Programs, return_bool_true) {
  auto value = executeString(R"(
    function main() bool {
        return 1 < 2;
    };
...
TEST(EndToEnd_Programs, return_bool_false) {
  auto value = executeString(R"(
    function main() bool {
        return 2 < 1;
    };
...
TEST(EndToEnd_Programs, return_i64) {
  auto value = executeString(R"(
    function main() i64 {
        return 42;
    };
...
TEST(EndToEnd_Programs, return_f32) {
  auto value = executeString(R"(
    function main() f32 {
        return 3.14;
    };
...
TEST(EndToEnd_Programs, return_f64) {
  auto value = executeString(R"(
    function main() f64 {
        return 2.718281828;
    };
...
TEST(EndToEnd_Programs, return_string) {
  auto value = executeString(R"(
...
TEST(EndToEnd_Programs, main_with_argc_argv_returns_argc) {
...
TEST(EndToEnd_Programs, main_with_argc_argv_no_args) {
...
TEST(EndToEnd_Programs, raw_ptr_type_parsing) {
...
// Reference tests
TEST(EndToEnd_Programs, ref_basic) {
...
TEST(EndToEnd_Programs, ref_modify_original) {
...
TEST(EndToEnd_Programs, ref_modify_through_ref) {
...
TEST(EndToEnd_Programs, ref_arithmetic) {
...
TEST(EndToEnd_Programs, ref_to_global) {
...
TEST(EndToEnd_Programs, minimal_transitive_import) {
...
TEST(EndToEnd_Programs, minimal_transitive_import_error) {
  // Import is now always a parse error
  EXPECT_THROW(executeString(R"(
    import "tests/programs/minimal_import_a.sun";
    function main() i32 {
...
TEST(EndToEnd_Programs, function_order_does_not_matter) {
  auto value = executeString(R"(
    function foo() i32 {
        return bar() + 1;
    };
