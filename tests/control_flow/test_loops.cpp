// tests/control_flow/test_loops.cpp
...
TEST(ControlFlow_Loops, for_basic_sum) {
...
TEST(ControlFlow_Loops, for_step_two) {
  auto value = executeString(R"(
    function main() i32 {
        var sum: i32 = 0;
...
TEST(ControlFlow_Loops, for_countdown) {
  auto value = executeString(R"(
    function main() i32 {
        var sum: i32 = 0;
...
TEST(ControlFlow_Loops, for_no_iterations) {
  auto value = executeString(R"(
    function main() i32 {
        var sum: i32 = 42;
...
TEST(ControlFlow_Loops, for_single_iteration) {
  auto value = executeString(R"(
    function main() i32 {
        var count: i32 = 0;
...
TEST(ControlFlow_Loops, for_large_iteration) {
  auto value = executeString(R"(
    function main() i32 {
        var sum: i32 = 0;
...
TEST(ControlFlow_Loops, while_basic_sum) {
  auto value = executeString(R"(
    function main() i32 {
        var sum: i32 = 0;
        var i: i32 = 0;
...
TEST(ControlFlow_Loops, while_countdown) {
  auto value = executeString(R"(
    function main() i32 {
        var sum: i32 = 0;
        var i: i32 = 5;
...
TEST(ControlFlow_Loops, while_no_iterations) {
  auto value = executeString(R"(
    function main() i32 {
        var result: i32 = 100;
        while (false) {
...
TEST(ControlFlow_Loops, while_single_iteration) {
  auto value = executeString(R"(
    function main() i32 {
        var count: i32 = 0;
        var done: bool = false;
...
TEST(ControlFlow_Loops, nested_for_loops) {
  auto value = executeString(R"(
    function main() i32 {
        var sum: i32 = 0;
...
TEST(ControlFlow_Loops, nested_while_loops) {
  auto value = executeString(R"(
    function main() i32 {
        var sum: i32 = 0;
        var i: i32 = 0;
...
TEST(ControlFlow_Loops, nested_for_while) {
  auto value = executeString(R"(
    function main() i32 {
        var total: i32 = 0;
        for (var i: i32 = 0; i < 3; i = i + 1) {
...
TEST(ControlFlow_Loops, triple_nested_for) {
  auto value = executeString(R"(
    function main() i32 {
        var count: i32 = 0;
...
TEST(ControlFlow_Loops, for_multiply_table) {
  auto value = executeString(R"(
    function main() i32 {
        var product: i32 = 1;
...
TEST(ControlFlow_Loops, while_power_of_two) {
  auto value = executeString(R"(
    function main() i32 {
        var result: i32 = 1;
        var count: i32 = 0;
...
TEST(ControlFlow_Loops, for_variable_bound) {
  auto value = executeString(R"(
    function main() i32 {
        var n: i32 = 5;
        var sum: i32 = 0;
...
TEST(ControlFlow_Loops, while_until_condition) {
  auto value = executeString(R"(
    function main() i32 {
        var x: i32 = 1;
        while (x < 100) {
...
TEST(ControlFlow_Loops, for_function_call_in_body) {
  auto value = executeString(R"(
...
TEST(ControlFlow_Loops, while_with_function_condition) {
  auto value = executeString(R"(
...
TEST(ControlFlow_Loops, loop_in_function) {
  auto value = executeString(R"(
...
TEST(ControlFlow_Loops, recursive_vs_loop_factorial) {
  auto value = executeString(R"(
...
TEST(ControlFlow_Loops, for_with_if_inside) {
  auto value = executeString(R"(
    function main() i32 {
        var evenSum: i32 = 0;
...
TEST(ControlFlow_Loops, while_with_early_exit_simulation) {
  auto value = executeString(R"(
    function main() i32 {
        var i: i32 = 0;
        var found: i32 = -1;
...
TEST(ControlFlow_Loops, nested_loop_with_condition) {
  auto value = executeString(R"(
    function main() i32 {
        var count: i32 = 0;
        for (var i: i32 = 1; i <= 5; i = i + 1) {
...
TEST(ControlFlow_Loops, for_float_accumulate) {
  auto value = executeString(R"(
    function main() f64 {
        var sum: f64 = 0.0;
        for (var i: i32 = 0; i < 5; i = i + 1) {
...
TEST(ControlFlow_Loops, while_float_convergence) {
  auto value = executeString(R"(
    function main() i32 {
        var x: f64 = 1.0;
        var count: i32 = 0;
...
TEST(ControlFlow_Loops, while_large_numbers) {
...
TEST(ControlFlow_Loops, for_zero_step_avoided) {
...
TEST(ControlFlow_Loops, while_complex_condition) {
  auto value = executeString(R"(
    function main() i32 {
        var a: i32 = 0;
        var b: i32 = 10;
...
TEST(ControlFlow_Loops, while_break_early) {
  auto value = executeString(R"(
    function main() i32 {
        var i: i32 = 0;
        while (i < 100) {
...
TEST(ControlFlow_Loops, for_break_early) {
  auto value = executeString(R"(
    function main() i32 {
        var sum: i32 = 0;
...
TEST(ControlFlow_Loops, break_find_first) {
  auto value = executeString(R"(
    function main() i32 {
        var found: i32 = -1;
...
TEST(ControlFlow_Loops, nested_break_inner) {
  auto value = executeString(R"(
    function main() i32 {
        var count: i32 = 0;
        for (var i: i32 = 0; i < 5; i = i + 1) {
...
TEST(ControlFlow_Loops, while_continue_skip) {
  auto value = executeString(R"(
    function main() i32 {
        var sum: i32 = 0;
        var i: i32 = 0;
...
TEST(ControlFlow_Loops, for_continue_skip) {
  auto value = executeString(R"(
    function main() i32 {
        var sum: i32 = 0;
        for (var i: i32 = 0; i < 10; i = i + 1) {
...
TEST(ControlFlow_Loops, continue_skip_multiples) {
  auto value = executeString(R"(
    function main() i32 {
        var sum: i32 = 0;
        for (var i: i32 = 1; i <= 20; i = i + 1) {
...
TEST(ControlFlow_Loops, nested_continue) {
  auto value = executeString(R"(
    function main() i32 {
        var count: i32 = 0;
        for (var i: i32 = 0; i < 3; i = i + 1) {
...
TEST(ControlFlow_Loops, break_and_continue) {
  auto value = executeString(R"(
    function main() i32 {
        var sum: i32 = 0;
...
TEST(ControlFlow_Loops, nested_break_continue) {
  auto value = executeString(R"(
    function main() i32 {
        var total: i32 = 0;
        for (var i: i32 = 0; i < 5; i = i + 1) {
...
TEST(ControlFlow_Loops, while_break_continue) {
  auto value = executeString(R"(
    function main() i32 {
        var sum: i32 = 0;
        var i: i32 = 0;
...
TEST(ControlFlow_ForInLoops, basic_iterator_sum) {
...
TEST(ControlFlow_ForInLoops, variable_named_in) {
...
TEST(ControlFlow_ForInLoops, error_class_without_iterator_interface) {
...
TEST(ControlFlow_ForInLoops, error_loop_var_type_mismatch) {
...
TEST(ControlFlow_ForInLoops, error_next_not_returning_option) {
...
TEST(ControlFlow_ForInLoops, iterable_with_separate_iterator) {
...
TEST(ControlFlow_ForInLoops, error_next_container_type_mismatch) {
...
TEST(ControlFlow_ForInLoops, error_iter_returns_mismatched_iterator) {
...
TEST(ControlFlow_ForInLoops, error_class_without_iterable_interface) {
