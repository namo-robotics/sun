...
TEST(ControlFlow_Ternary, true_takes_then_branch) {
...
TEST(ControlFlow_Ternary, false_takes_else_branch) {
  auto value = executeString(R"(
      function main() i32 {
          var c = false;
          return c ? 1 : 2;
...
TEST(ControlFlow_Ternary, float_branches) {
  auto value = executeString(R"(
      function main() i32 {
          var c = true;
          var x = c ? 1.5 : 2.5;
...
TEST(ControlFlow_Ternary, comparison_condition) {
  auto value = executeString(R"(
      function main() i32 {
          var n = 7;
          return n > 5 ? 10 : 20;
...
TEST(ControlFlow_Ternary, as_var_initializer) {
  auto value = executeString(R"(
      function main() i32 {
          var c = false;
          var x = c ? 3 : 4;
...
TEST(ControlFlow_Ternary, as_call_argument) {
  auto value = executeString(R"(
...
TEST(ControlFlow_Ternary, in_assignment_and_compound_assignment) {
  auto value = executeString(R"(
      function main() i32 {
          var c = true;
          var x: i32 = 0;
...
TEST(ControlFlow_Ternary, nonzero_integer_condition_is_true) {
  auto value = executeString(R"(
      function main() i32 {
          var n = 5;
          return n ? 1 : 2;
...
TEST(ControlFlow_Ternary, zero_integer_condition_is_false) {
  auto value = executeString(R"(
      function main() i32 {
          var n = 0;
          return n ? 1 : 2;
...
TEST(ControlFlow_Ternary, ast_shape_right_associative) {
...
TEST(ControlFlow_Ternary, ast_shape_nested_then_branch) {
  // a ? b ? c : d : e parses as a ? (b ? c : d) : e
  auto ast = parseStatementToAst("a ? b ? c : d : e;");
  ASSERT_NE(ast, nullptr);
  ASSERT_EQ(ast->getType(), ASTNodeType::TERNARY);
...
TEST(ControlFlow_Ternary, ast_shape_or_binds_tighter) {
...
TEST(ControlFlow_Ternary, chained_runtime) {
  auto value = executeString(R"(
...
TEST(ControlFlow_Ternary, arithmetic_branches) {
  auto value = executeString(R"(
      function main() i32 {
          var c = false;
          return c ? 1 + 2 : 3 * 4;
...
TEST(ControlFlow_Ternary, logical_condition_runtime) {
  auto value = executeString(R"(
      function main() i32 {
          var x = false;
          var y = true;
...
TEST(ControlFlow_Ternary, integer_literal_adopts_i64) {
  auto value = executeString(R"(
      function main() i32 {
          var a: i64 = 500;
          var c = true;
...
TEST(ControlFlow_Ternary, integer_literal_adopts_i64_reversed) {
  auto value = executeString(R"(
      function main() i32 {
          var a: i64 = 500;
          var c = false;
...
TEST(ControlFlow_Ternary, widens_i32_to_i64) {
  auto value = executeString(R"(
      function main() i32 {
          var a: i32 = 3;
...
TEST(ControlFlow_Ternary, widens_i32_to_i64_taken_narrow_side) {
  auto value = executeString(R"(
      function main() i32 {
          var a: i32 = 3;
          var b: i64 = 4000000000;
...
TEST(ControlFlow_Ternary, widens_f32_to_f64) {
  auto value = executeString(R"(
      function main() i32 {
          var a: f32 = 1.5;
          var b: f64 = 2.5;
...
TEST(ControlFlow_Ternary, incompatible_branch_types_error) {
...
TEST(ControlFlow_Ternary, class_branches_pick_field) {
  auto value = executeString(R"(
      class Point {
        var x: i32;
        var y: i32;
...
TEST(ControlFlow_Ternary, as_array_index) {
  auto value = executeString(R"(
      function main() i32 {
          var arr = [10, 20, 30];
          var c = false;
...
TEST(ControlFlow_Ternary, slice_syntax_still_parses) {
...
TEST(ControlFlow_Ternary, parenthesized_ternary_as_slice_bound_parses) {
...
TEST(ControlFlow_Ternary, unparenthesized_ternary_in_index_consumes_colon) {
...
TEST(ControlFlow_Ternary, inside_generic_function) {
  auto value = executeString(R"(
...
TEST(ControlFlow_Ternary, missing_colon_is_parse_error) {
  EXPECT_SUN_ERROR_WITH_MESSAGE(executeString(R"(
      function main() i32 {
          var c = true;
          var x = c ? 1;
...
TEST(ControlFlow_Ternary, missing_else_operand_is_parse_error) {
  EXPECT_SUN_ERROR_WITH_MESSAGE(executeString(R"(
      function main() i32 {
          var c = true;
          var x = c ? 1 : ;
