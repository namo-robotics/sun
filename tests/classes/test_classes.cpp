// tests/classes/test_classes.cpp - Tests for class support
...
TEST(Classes, simple_class_definition) {
...
TEST(Classes, class_with_method) {
  auto value = executeString(R"(
    class Counter {
      var value: i32;
...
TEST(Classes, duplicate_field_error_has_location) {
  try {
    executeString(R"(
    class Point {
      var x: i32;
...
TEST(Classes, constructor_wrong_argument_count) {
...
TEST(Classes, partial_class_adds_methods) {
...
TEST(Classes, partial_class_mutual_calls) {
...
TEST(Classes, partial_class_no_fields_error) {
...
TEST(Classes, partial_class_no_constructor_error) {
...
TEST(Classes, partial_class_duplicate_method_error) {
...
TEST(Classes, partial_class_inline_simple) {
...
TEST(Classes, simple_member_assignment) {
...
TEST(Classes, nested_member_assignment) {
...
TEST(Classes, deep_nested_member_assignment) {
...
TEST(Classes, this_nested_member_assignment) {
...
TEST(Classes, nested_member_access_as_argument) {
...
TEST(Classes, member_access_on_function_return) {
...
TEST(Classes, method_call_on_function_return) {
...
TEST(Classes, nested_member_access_on_temporary) {
...
TEST(Classes, temporary_as_argument_primitive) {
...
TEST(Classes, temporary_class_as_ref_argument) {
...
TEST(Classes, constructor_as_ref_argument) {
...
TEST(Classes, chained_member_access_as_argument) {
...
TEST(Classes, chained_method_and_member_as_argument) {
...
TEST(Classes, deinit_called_at_implicit_function_exit) {
  auto value = executeString(R"(
    var counter: i32 = 0;
...
TEST(Classes, deinit_called_at_explicit_return) {
  auto value = executeString(R"(
    var counter: i32 = 0;
...
TEST(Classes, deinit_called_for_multiple_instances) {
  auto value = executeString(R"(
    var counter: i32 = 0;
...
TEST(Classes, explicit_deinit_no_double_call) {
  auto value = executeString(R"(
    var counter: i32 = 0;
...
TEST(Classes, method_calls_generic_class_declared_below_it) {
  auto value = executeString(R"(
    class Node {
        var v: i32;
        function init(v: i32) { this.v = v; }
