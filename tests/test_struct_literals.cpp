// tests/test_struct_literals.cpp — `{ field: value }` construction
//
...
TEST(StructLiteralTest, initializes_fields_by_name) {
...
TEST(StructLiteralTest, field_order_does_not_have_to_match_declaration) {
...
TEST(StructLiteralTest, mixed_field_types) {
  auto value = executeString(R"(
    class M {
      var n: i32;
      var big: i64;
...
TEST(StructLiteralTest, trailing_comma_allowed) {
  auto value = executeString(R"(
...
TEST(StructLiteralTest, single_field_class) {
  auto value = executeString(R"(
    class One { var v: i32; }
    function main() i32 {
      var o: One = { v: 42 };
...
TEST(StructLiteralTest, field_values_can_be_expressions) {
  auto value = executeString(R"(
    class P { var a: i32; var b: i32; }
...
TEST(StructLiteralTest, works_for_global_variables) {
  auto value = executeString(R"(
...
TEST(StructLiteralTest, nested_class_field) {
  auto value = executeString(R"(
...
TEST(StructLiteralTest, rejects_positional_construction) {
...
TEST(StructLiteralTest, rejects_unknown_field) {
  EXPECT_THROW(executeString(R"(
    class Car { var color: i32; var speed: i32; }
    function main() i32 {
...
TEST(StructLiteralTest, rejects_missing_field) {
...
TEST(StructLiteralTest, rejects_duplicate_field) {
  EXPECT_THROW(executeString(R"(
    class Car { var color: i32; var speed: i32; }
    function main() i32 {
...
TEST(StructLiteralTest, rejects_wrong_field_type) {
  EXPECT_THROW(executeString(R"(
...
TEST(StructLiteralTest, requires_a_type_annotation) {
...
TEST(StructLiteralTest, rejects_literal_for_a_class_with_init) {
...
TEST(StructLiteralTest, formatter_round_trip) {
...
TEST(StructLiteralTest, nested_class_field_in_a_global) {
