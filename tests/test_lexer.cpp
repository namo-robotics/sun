...
TEST(LexerTest, Utf8InStringLiteral) {
...
TEST(LexerTest, Utf8InTemplateString) {
...
TEST(LexerTest, ColumnsCountBytes) {
...
TEST(LexerTest, LongestMatchWins) {
  EXPECT_EQ(kindsOf(">>="),
...
TEST(LexerTest, FloatBeatsIntegerFollowedByDot) {
...
TEST(LexerTest, KeywordVsIdentifierPriority) {
...
TEST(LexerTest, UnderscoreVsIntrinsicIdentifier) {
...
TEST(LexerTest, PositionsAcrossMultiLineBlockComment) {
...
TEST(LexerTest, PositionsAfterLineComment) {
...
TEST(LexerTest, EofPositionAfterTrailingWhitespace) {
...
TEST(LexerTest, RelexFromSavedPosition) {
...
TEST(LexerTest, RelexAfterInputExhausted) {
...
TEST(LexerTest, ParsesComparisonAtEndOfInput) {
...
TEST(LexerTest, SharedDfaCacheStopsGrowing) {
...
TEST(LexerTest, DfaStateCountStaysBounded) {
...
TEST(LexerTest, DISABLED_ThroughputMBps) {
  std::string unit =
...
TEST(LexerTest, DISABLED_ConstructionCost) {
