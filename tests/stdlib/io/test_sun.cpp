...
TEST_F(Stdlib_Io_Sun, lseek_to_beginning) {
...
TEST_F(Stdlib_Io_Sun, lseek_to_end) {
...
TEST_F(Stdlib_Io_Sun, fsync_success) {
...
TEST_F(Stdlib_Io_Sun, ftruncate_shrink) {
...
TEST_F(Stdlib_Io_Sun, ftruncate_extend) {
...
TEST_F(Stdlib_Io_Sun, unlink_file) {
...
TEST_F(Stdlib_Io_Sun, unlink_nonexistent) {
...
TEST_F(Stdlib_Io_Sun, rename_file) {
...
TEST_F(Stdlib_Io_Sun, mkdir_and_rmdir) {
...
TEST_F(Stdlib_Io_Sun, rmdir_nonempty_fails) {
...
TEST_F(Stdlib_Io_Sun, write_and_read_raw_bytes) {
...
TEST_F(Stdlib_Io_Sun, integration_create_write_seek_truncate) {
